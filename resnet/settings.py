...
tf.app.flags.DEFINE_integer('num_examples_train', 1000000, "Number of examples for training")
...
tf.app.flags.DEFINE_float('lr_decay_epoches', 6.0, "Epochs after which learning rate decays.")
